...
var num; //num 변수생성 1 - 2 - 3순서
num = 1; //1을 num에 대입한다(변수에 값 대입) 4 - 6 - 5 - 7순서
var num2 = 2; //생성과 대입 1 - 2 - 4 - 3 - 5순서
// 콘솔 실행 함수
console.log(num2);
// 객체.함수(실행하는값);
// 콘솔창에(객체)에 num2변수값(실행값)을 로그로 출력(실행함수)하겠다
console.log(num);
//=================================2일차 25/05/13
var bowl;
bowl = '쌀'; // bowl에는 가장 마지막에 쓰인게 표시된다
console.log(bowl); //쌀
bowl = '콩';
console.log(bowl); //콩
// 자바스크립트는 절차적 언어이기 때문에 CSS처럼 우선순위에 따라 최종결과값만 인식하는 것이 아닌 함수의 작성 위치에 따라 다른 변수값을 인식할 수 있다.
var a = 1;
var b = 5;
var c = 10;
...
console.log(box2+' '+box3+'는 '+typeof(box2+box3)+'이다.');//hello javascript는 String이다.
...
console.log(box4);
console.log(box3.length); //hello의 문자 개수는?
//객체.속성;
//객체.함수();
console.log('-----------------------')
var num1 = 10;
...
console.log("she's gone")//she's gone 중간에 '가 들어가는 경우 ""를 쓴다
console.log('------------------------');
...
//dan99 변수에 데이터가 변결될때 함께 달라지는 결과는 %{}으로 프로그래밍식으로 처리
