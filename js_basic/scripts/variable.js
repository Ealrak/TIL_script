...
let rectagle = { //rectagle 객체변수명은 콜스택 저장
    w:0, //{width~color} 객체모든속성은 메모리힙 저장
    h:200,
    x:0,
    y:100,
    border:0,
...
console.log(user_info.name, user_info.age);
...
console.log(movie_theater.name, movie_theater.location);
//오늘 VIP좌석 F1번 20000원에 예약했다.
console.log(`오늘 ${movie_theater.name}좌석 ${movie_theater.location}번 ${movie_theater.price}에 예약했다.`);
//=========================배열 공부
//배열 작성법1.(값은 개수 제한 없음, 최소 2개 이상)
