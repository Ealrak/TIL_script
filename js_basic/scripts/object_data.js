...
const movieInfo_v2 = {
    ...
    director:['애덤 스타인','잭 리포브스키'],
    genre:'공포(호러)',
    releaseDate:'2025.05.14',
    age:19,
    story:'집안 대대로 내려오는 죽음의 저주...',
}
...
console.log(movieAll[0].name,movieAll[1].story)
//감독 : 크리스토퍼 맥쿼리
//장르 : 액션 / 169분
//등급 : 15세 이상 관람가
...
//hello figma
console.log(greeting+lang[0]);//hello + figma
...
//================빼기, 곱하기, 나누기 등 연산은 숫자가 문자로 따옴표로 묶여 있을 시 자동으로 숫자로 형변환시킨다.
const data1 = 1;
const data7 = "7";
