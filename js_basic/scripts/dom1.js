...
// (비회원인 경우) 주문하기 버튼(buyBtn)을 클릭했을 때(click) '회원만 주문할 수 있습니다' 메세지 출력(함수)
// 주문하기 버튼 == DOM객체변수
...
//userId.style.border = '3px solid red'; //즉시실행 테스트
function focusGreen() {
...
//쇼핑몰 상품 수량 입력 알고리즘
//기본 수량 1
//사용자가 숫자입력을 위해서 커서를 두면 배경색 노랑변경
//커서를 빼면 배경색 흰색
...
//3. 함수
//JS에서 상대경로 연결 시 js파일 기준이 아닌 js가 연결된 html파일이 저장돤 위치를 기준으로 상대경로를 작성한다.
function link0520() {
